...
require_once("include/002_producto_mod_oap_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "002_producto_mod_oap" );
