...
function buttonHandler_help_a($params)
{
	global $strTableName;
	$result = array();
...
function buttonHandler_ha($params)
{
	global $strTableName;
	$result = array();
...
function buttonHandler_hb($params)
{
	global $strTableName;
	$result = array();
