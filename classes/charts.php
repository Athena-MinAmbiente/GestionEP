...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("paa_master" == $this->chrt_array['tables'][0])
			return true;
		if("q_ctrl_saldos_act_paa_1" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master" == $this->chrt_array['tables'][0])
			return true;
		if("q_recursos_gestor_c1" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master_msj" == $this->chrt_array['tables'][0])
			return true;
		...
		if("002_producto" == $this->chrt_array['tables'][0])
			return true;
		if("q_recursos_gestor_f" == $this->chrt_array['tables'][0])
			return true;
		...
		if("q_recursos_gestor_f1" == $this->chrt_array['tables'][0])
			return true;
		if("q_info_paa_secgen" == $this->chrt_array['tables'][0])
			return true;
		if("q_info_paa_secgen" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master" == $this->chrt_array['tables'][0])
		...
		if("paa_master" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_publicarsecop" == $this->chrt_array['tables'][0])
			return true;
		if("q_paa_integrados" == $this->chrt_array['tables'][0])
			return true;
		if("q_informe_export_secop" == $this->chrt_array['tables'][0])
			return true;
		if("q_informe_export_secop_no_aprobadas" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master" == $this->chrt_array['tables'][0])
			return true;
		if("q_ctrl_saldo_0000c" == $this->chrt_array['tables'][0])
			return true;
		if("q_ctrl_saldo_0000c" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("q_ctrl_saldo_0001c" == $this->chrt_array['tables'][0])
			return true;
		if("q_ctrl_saldo_0001f" == $this->chrt_array['tables'][0])
			return true;
		if("q_seg_prog_inversion_x_rubro_001" == $this->chrt_array['tables'][0])
			return true;
		if("q_info_paa" == $this->chrt_array['tables'][0])
			return true;
		if("q_seg_prog_funcionamiento_001" == $this->chrt_array['tables'][0])
			return true;
		if("q_info_paa" == $this->chrt_array['tables'][0])
			return true;
		if("q_seg_prog_funcionamiento_001" == $this->chrt_array['tables'][0])
		...
		if("q_seg_prog_inversion_x_rubro_001" == $this->chrt_array['tables'][0])
			return true;
		if("q_ctrl_saldo_00021c" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_patrimonios" == $this->chrt_array['tables'][0])
			return true;
		if("q_reporte_oaps_000" == $this->chrt_array['tables'][0])
			return true;
		if("q_seg_prog_inversion_001" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master" == $this->chrt_array['tables'][0])
		...
		if("paa_master" == $this->chrt_array['tables'][0])
			return true;
		if("002_producto_mod" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_tipomod" == $this->chrt_array['tables'][0])
			return true;
		if("002_producto" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_mod_estado" == $this->chrt_array['tables'][0])
			return true;
		if("002_producto_mod" == $this->chrt_array['tables'][0])
			return true;
		if("002_producto" == $this->chrt_array['tables'][0])
		...
		if("paa_master_pscdp" == $this->chrt_array['tables'][0])
			return true;
		if("scdp_event_type" == $this->chrt_array['tables'][0])
			return true;
		if("scdp_event_type_actividad" == $this->chrt_array['tables'][0])
			return true;
		if("scdp_tracking" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master" == $this->chrt_array['tables'][0])
			return true;
		if("global_uc" == $this->chrt_array['tables'][0])
			return true;
		...
		if("q_recursos_gestor_f" == $this->chrt_array['tables'][0])
			return true;
		if("nopaa_master" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("nopaa_master" == $this->chrt_array['tables'][0])
			return true;
		if("q_ctrl_saldos_prod_paa_1" == $this->chrt_array['tables'][0])
			return true;
		if("nopaa_master" == $this->chrt_array['tables'][0])
			return true;
		if("nopaa_master" == $this->chrt_array['tables'][0])
			return true;
		if("q_info_nopaa_integrado" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master_pscdp" == $this->chrt_array['tables'][0])
			return true;
		if("global_tipo_cdp" == $this->chrt_array['tables'][0])
			return true;
		if("nopaa_master" == $this->chrt_array['tables'][0])
			return true;
		if("nopaa_master" == $this->chrt_array['tables'][0])
		...
		if("nopaa_master" == $this->chrt_array['tables'][0])
			return true;
		if("q_info_actividad" == $this->chrt_array['tables'][0])
			return true;
		if("q_info_producto" == $this->chrt_array['tables'][0])
			return true;
		if("nopaa_master" == $this->chrt_array['tables'][0])
			return true;
		if("nopaa_master" == $this->chrt_array['tables'][0])
		...
		if("nopaa_master" == $this->chrt_array['tables'][0])
			return true;
		if("q_contrato_paa" == $this->chrt_array['tables'][0])
			return true;
		if("q_001_dashboard" == $this->chrt_array['tables'][0])
			return true;
		if("global_fecha_actualiza_siif" == $this->chrt_array['tables'][0])
			return true;
		if("009_ep_agregada" == $this->chrt_array['tables'][0])
			return true;
		if("010_ep_desagregada" == $this->chrt_array['tables'][0])
			return true;
		if("007_cdp" == $this->chrt_array['tables'][0])
			return true;
		if("006_compromisos" == $this->chrt_array['tables'][0])
			return true;
		if("011_obligaciones" == $this->chrt_array['tables'][0])
			return true;
		if("012_odp" == $this->chrt_array['tables'][0])
			return true;
		if("contractor_master" == $this->chrt_array['tables'][0])
			return true;
		if("q_ep_000" == $this->chrt_array['tables'][0])
			return true;
		if("000_global" == $this->chrt_array['tables'][0])
			return true;
		if("001_rubro" == $this->chrt_array['tables'][0])
		...
		if("002_producto" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_fuente_siif" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_tiporubro" == $this->chrt_array['tables'][0])
			return true;
		if("gestionep_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("gestionep_ugmembers" == $this->chrt_array['tables'][0])
			return true;
		if("global_users" == $this->chrt_array['tables'][0])
			return true;
		return false;
