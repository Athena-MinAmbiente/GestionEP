...
class Security
{
	...
	public static function getUserGroups()
	{
		...
		$sql = "select ". $grConnection->addFieldWrappers( "Label" )
			." from ". $grConnection->addTableWrappers( "gestionep_uggroups" ) . " WHERE " . $grConnection->addFieldWrappers( "GroupID" )
	...
	*  For AD it is <provider code><username>
	...
	public static function getUgMembersDatasource() {
		...
		global $cman;
		return getDbTableDataSource( "gestionep_ugmembers", $cman->getUserGroupsConnId() );
	}
	...
	public static function getUgGroupsDatasource() {
		...
		global $cman;
		return getDbTableDataSource( "gestionep_uggroups", $cman->getUserGroupsConnId() );
	}
	...
	public static function getUgRightsDatasource() {
		...
		global $cman;
		return getDbTableDataSource( "gestionep_ugrights", $cman->getUserGroupsConnId() );
	}
	...
	public static function  fillTablesOwnerId( $data, $provider ) {
		...
		if( $securityType == stAD && !$provider["useDbGroups"] ) {
			...
			storageSet( "_funcionario_OwnerID", $userId );
						storageSet( "_q_recursos_gestor_c_OwnerID", $userId );
						storageSet( "_q_recursos_gestor_c1_OwnerID", $userId );
						storageSet( "_paa_master_integrado_OwnerID", $userId );
						storageSet( "_paa_master_stat_6_OwnerID", $userId );
						storageSet( "_q_seg_prog_inversion_001_OwnerID", $userId );
						storageSet( "_paa_master_stat_4_c_OwnerID", $userId );
						storageSet( "_paa_master_stat_4_f_OwnerID", $userId );
						storageSet( "_paa_master_stat_4_c_integrado_OwnerID", $userId );
						storageSet( "_paa_master_stat_4_f_integrado_OwnerID", $userId );
						storageSet( "_002_producto_m_OwnerID", $userId );
						storageSet( "_q_recursos_gestor_f_OwnerID", $userId );
						storageSet( "_q_recursos_gestor_c2_OwnerID", $userId );
						storageSet( "_q_recursos_gestor_f2_OwnerID", $userId );
						storageSet( "_nopaa_master_f_s5_OwnerID", $userId );
						storageSet( "_nopaa_master_c_s5_OwnerID", $userId );
						storageSet( "_nopaa_master_c_s5i_OwnerID", $userId );
						storageSet( "_nopaa_master_f_s5i_OwnerID", $userId );
		} else {
						storageSet( "OwnerID", $data["idusrglobal"] );
			storageSet( "_funcionario_OwnerID", $data["idusrglobal"] );
						storageSet( "_q_recursos_gestor_c_OwnerID", $data["Username"] );
						storageSet( "_q_recursos_gestor_c1_OwnerID", $data["idusrglobal"] );
						storageSet( "_paa_master_integrado_OwnerID", $data["Username"] );
						storageSet( "_paa_master_stat_6_OwnerID", $data["Username"] );
						storageSet( "_q_seg_prog_inversion_001_OwnerID", $data["idusrglobal"] );
						storageSet( "_paa_master_stat_4_c_OwnerID", $data["Username"] );
						storageSet( "_paa_master_stat_4_f_OwnerID", $data["Username"] );
						storageSet( "_paa_master_stat_4_c_integrado_OwnerID", $data["Username"] );
						storageSet( "_paa_master_stat_4_f_integrado_OwnerID", $data["Username"] );
						storageSet( "_002_producto_m_OwnerID", $data["Username"] );
						storageSet( "_q_recursos_gestor_f_OwnerID", $data["Username"] );
						storageSet( "_q_recursos_gestor_c2_OwnerID", $data["idusrglobal"] );
						storageSet( "_q_recursos_gestor_f2_OwnerID", $data["Username"] );
						storageSet( "_nopaa_master_f_s5_OwnerID", $data["Username"] );
						storageSet( "_nopaa_master_c_s5_OwnerID", $data["Username"] );
						storageSet( "_nopaa_master_c_s5i_OwnerID", $data["Username"] );
						storageSet( "_nopaa_master_f_s5i_OwnerID", $data["Username"] );
		}
	}
