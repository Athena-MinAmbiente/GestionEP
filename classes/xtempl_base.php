...
class XTempl_Base
{
	 ...
	 function __construct( $hideAddedCharts = false )
	{
		...
		{
			$this->assign_function("q_ctrl_saldo_0000c_chart_chart","xt_showchart",
			array(
				"chartName"=>"q_ctrl_saldo_0000c_chart",
				"table"=>"q_ctrl_saldo_0000c Chart",
				"ctype"=>"Combined"));
			$this->assign_function("q_ctrl_saldo_0000f_chart_chart","xt_showchart",
			array(
				"chartName"=>"q_ctrl_saldo_0000f_chart",
				"table"=>"q_ctrl_saldo_0000f Chart",
				"ctype"=>"Combined"));
			$this->assign_function("q_seg_prog_funcionamiento_001_chart_chart","xt_showchart",
			array(
				"chartName"=>"q_seg_prog_funcionamiento_001_chart",
				"table"=>"q_seg_prog_funcionamiento_001 Chart",
				"ctype"=>"Combined"));
			$this->assign_function("q_seg_prog_inversion_x_rubro_001_chart_chart","xt_showchart",
			array(
				"chartName"=>"q_seg_prog_inversion_x_rubro_001_chart",
				"table"=>"q_seg_prog_inversion_x_rubro_001 Chart",
				"ctype"=>"Combined"));
			$this->assign_function("q_ep_000_chart_chart","xt_showchart",
			array(
				"chartName"=>"q_ep_000_chart",
				"table"=>"q_ep_000 Chart",
				"ctype"=>"2DColumn"));
		}
