...
;
		...
		$this->_connectionsIdByName["dbsep at 127.0.0.1"] = "sep2_at_127_0_0_1";
...
;
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "mincit_global_20x_at_127_0_0_1";
		$data["connName"] = "dbgpaa at 127.0.0.1";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;127.0.0.1;root;1qaz2wsx;3307;dbgpaa;;1"; //currently unused

		$this->_connectionsIdByName["dbgpaa at 127.0.0.1"] = "mincit_global_20x_at_127_0_0_1";
...
;
		...
		$connectionsData["mincit_global_20x_at_127_0_0_1"] = $data;
