...
require_once("include/global_fecha_actualiza_siif_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "global_fecha_actualiza_siif" );
