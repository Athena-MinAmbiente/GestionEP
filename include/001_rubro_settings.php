...
$tdata001_rubro[".OwnerID"] = "Dependencia";
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabels001_rubro["Spanish"]["BPIN"] = "Código BPIN";
	...
	$fieldLabels001_rubro["Spanish"]["TIPO_FUENTE"] = "Fuente de rubro";
	...
	$fieldLabels001_rubro["Spanish"]["RUBRO_ID_FK"] = "NOMBRE UEJ";
	...
	$fieldLabels001_rubro["Spanish"]["UTILIZADO"] = "Programado";
	$fieldToolTips001_rubro["Spanish"]["UTILIZADO"] = "";
	$placeHolders001_rubro["Spanish"]["UTILIZADO"] = "";
	$pageTitles001_rubro["Spanish"]["add"] = "Rubro presupuestal | Inversión";
	$pageTitles001_rubro["Spanish"]["edit"] = "Rubro presupuestal | Inversión";
...
$tdata001_rubro[".mainTableOwnerID"] = "Dependencia";
$tdata001_rubro[".entityType"] = 0;
$tdata001_rubro[".connId"] = "sep2_at_127_0_0_1";
...
if( $pages[PAGE_EDIT] ) {
	...
	$tdata001_rubro[".afterEditAction"] = 0;
	$tdata001_rubro[".closePopupAfterEdit"] = 1;
	$tdata001_rubro[".afterEditActionDetTable"] = "002_producto";
}

if( $pages[PAGE_ADD] ) {
$tdata001_rubro[".add"] = true;
$tdata001_rubro[".afterAddAction"] = 0;
$tdata001_rubro[".closePopupAfterAdd"] = 1;
$tdata001_rubro[".afterAddActionDetTable"] = "002_producto";
}
...
$tdata001_rubro[".googleLikeFields"][] = "UTILIZADO";
...
$tdata001_rubro[".sqlHead"] = "SELECT RUBRO_ID,  RUBRO_ID_FK,  VIGENCIA,  UEJ,  RUBRO,  DESCRIPCION,  REC,  FUENTE,  TIPO,  TIPO_FUENTE,  BPIN,  PRESUPUESTO,  SALDO,  Dependencia,  UsuarioResp,  CATEGORIA,  OBJ_GENERAL,  OBJ_ESPECIFICO,  UTILIZADO";
...
$tdata001_rubro[".arrGridTabs"] = $arrGridTabs;
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "001_rubro";
	$fdata["Label"] = GetFieldLabel("001_rubro","UTILIZADO");
	$fdata["FieldType"] = 14;
...
//end of Filters settings
	...
	$tdata001_rubro["UTILIZADO"] = $fdata;
		$tdata001_rubro[".searchableFields"][] = "UTILIZADO";
...
changeTextControlsToDate( "001_rubro" );
...
$masterTablesData["001_rubro"] = array();
	...
	$masterTablesData["001_rubro"][0]["masterKeys"][]="RUBRO_ID";
				$masterTablesData["001_rubro"][0]["masterKeys"][]="VIGENCIA";
				$masterTablesData["001_rubro"][0]["detailKeys"] = array();
	$masterTablesData["001_rubro"][0]["detailKeys"][]="RUBRO_ID_FK";
				$masterTablesData["001_rubro"][0]["detailKeys"][]="VIGENCIA";
...
$proto45["m_srcTableName"] = "001_rubro";
...
$proto44["m_alias"] = "";
$proto44["m_srcTableName"] = "001_rubro";
$proto46=array();
$proto46["m_sql"] = "";
