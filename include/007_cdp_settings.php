...
$tdata007_cdp[".pagesByType"] = my_json_decode( "{\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdata007_cdp[".originalPagesByType"] = $tdata007_cdp[".pagesByType"];
$tdata007_cdp[".pages"] = types2pages( my_json_decode( "{\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdata007_cdp[".originalPages"] = $tdata007_cdp[".pages"];
$tdata007_cdp[".defaultPages"] = my_json_decode( "{\"export\":\"export\",\"import\":\"import\",\"list\":\"list\",\"print\":\"print\",\"search\":\"search\",\"view\":\"view\"}" );
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabels007_cdp["Spanish"]["cdp_id"] = "Cdp Id";
	$fieldToolTips007_cdp["Spanish"]["cdp_id"] = "";
	$placeHolders007_cdp["Spanish"]["cdp_id"] = "";
	$fieldLabels007_cdp["Spanish"]["FA"] = "Fecha de subida";
	$fieldToolTips007_cdp["Spanish"]["FA"] = "";
	$placeHolders007_cdp["Spanish"]["FA"] = "";
	...
	$fieldLabels007_cdp["Spanish"]["FECHA_ACTUALIZACION"] = "FECHA ACTUALIZACION";
	$fieldToolTips007_cdp["Spanish"]["FECHA_ACTUALIZACION"] = "";
	$placeHolders007_cdp["Spanish"]["FECHA_ACTUALIZACION"] = "";
...
$tdata007_cdp[".connId"] = "sep2_at_127_0_0_1";
...
$tdata007_cdp[".badgeColor"] = "00C2C5";
...
$tdata007_cdp[".googleLikeFields"][] = "cdp_id";
$tdata007_cdp[".googleLikeFields"][] = "FA";
...
$tdata007_cdp[".googleLikeFields"][] = "FECHA_ACTUALIZACION";
...
$tdata007_cdp[".sqlHead"] = "SELECT cdp_id,  	FA,  	`Numero Documento`,  	`Fecha de Registro`,  	`Fecha de Creacion`,  	`Tipo de CDP`,  	Estado,  	Dependencia,  	`Dependencia Descripcion`,  	Rubro,  	Descripcion,  	Fuente,  	Recurso,  	Sit,  	`Valor Inicial`,  	`Valor Operaciones`,  	`Valor Actual`,  	`Saldo por Comprometer`,  	Objeto,  	`Solicitud CDP`,  	Compromisos,  	`Cuentas por Pagar`,  	Obligaciones,  	`Ordenes de Pago`,  	Reintegros,  	FECHA_ACTUALIZACION";
...
//	Custom field settings
	...
	$fdata["Label"] = GetFieldLabel("007_cdp","cdp_id");
	$fdata["FieldType"] = 3;
...
//end of Filters settings
	...
	$tdata007_cdp["cdp_id"] = $fdata;
		$tdata007_cdp[".searchableFields"][] = "cdp_id";
//	FA
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 2;
	...
	$fdata["GoodName"] = "FA";
	$fdata["ownerTable"] = "007_cdp";
	$fdata["Label"] = GetFieldLabel("007_cdp","FA");
	$fdata["FieldType"] = 7;
...
//Filters settings
	$fdata["filterTotals"] = 1;
		...
		$fdata["filterTotalFields"] = "cdp_id";
		$fdata["filterFormat"] = "Values list";
		$fdata["showCollapsed"] = false;
...
//end of Filters settings
	...
	$tdata007_cdp["FA"] = $fdata;
		$tdata007_cdp[".searchableFields"][] = "FA";
//	Numero Documento
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 3;
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "007_cdp";
	$fdata["Label"] = GetFieldLabel("007_cdp","FECHA_ACTUALIZACION");
	$fdata["FieldType"] = 7;
...
//end of Filters settings
	...
	$tdata007_cdp["FECHA_ACTUALIZACION"] = $fdata;
		$tdata007_cdp[".searchableFields"][] = "FECHA_ACTUALIZACION";
...
$proto0["m_strFieldList"] = "cdp_id,  	FA,  	`Numero Documento`,  	`Fecha de Registro`,  	`Fecha de Creacion`,  	`Tipo de CDP`,  	Estado,  	Dependencia,  	`Dependencia Descripcion`,  	Rubro,  	Descripcion,  	Fuente,  	Recurso,  	Sit,  	`Valor Inicial`,  	`Valor Operaciones`,  	`Valor Actual`,  	`Saldo por Comprometer`,  	Objeto,  	`Solicitud CDP`,  	Compromisos,  	`Cuentas por Pagar`,  	Obligaciones,  	`Ordenes de Pago`,  	Reintegros,  	FECHA_ACTUALIZACION";
...
$proto22["m_sql"] = "`Dependencia Descripcion`";
...
$proto36["m_sql"] = "`Valor Operaciones`";
...
$proto40["m_sql"] = "`Saldo por Comprometer`";
...
$proto48["m_sql"] = "`Cuentas por Pagar`";
...
$proto54["m_sql"] = "Reintegros";
$proto54["m_srcTableName"] = "007_cdp";
$proto54["m_expr"]=$obj;
$proto54["m_alias"] = "";
...
$proto56["m_sql"] = "FECHA_ACTUALIZACION";
$proto56["m_srcTableName"] = "007_cdp";
$proto56["m_expr"]=$obj;
$proto56["m_alias"] = "";
...
$proto58["m_link"] = "SQLL_MAIN";
			$proto59=array();
$proto59["m_strName"] = "007_cdp";
$proto59["m_srcTableName"] = "007_cdp";
$proto59["m_columns"] = array();
$proto59["m_columns"][] = "cdp_id";
$proto59["m_columns"][] = "FA";
$proto59["m_columns"][] = "Numero Documento";
$proto59["m_columns"][] = "Fecha de Registro";
$proto59["m_columns"][] = "Fecha de Creacion";
$proto59["m_columns"][] = "Tipo de CDP";
$proto59["m_columns"][] = "Estado";
$proto59["m_columns"][] = "Dependencia";
$proto59["m_columns"][] = "Dependencia Descripcion";
$proto59["m_columns"][] = "Rubro";
$proto59["m_columns"][] = "Descripcion";
$proto59["m_columns"][] = "Fuente";
$proto59["m_columns"][] = "Recurso";
$proto59["m_columns"][] = "Sit";
$proto59["m_columns"][] = "Valor Inicial";
$proto59["m_columns"][] = "Valor Operaciones";
$proto59["m_columns"][] = "Valor Actual";
$proto59["m_columns"][] = "Saldo por Comprometer";
$proto59["m_columns"][] = "Objeto";
$proto59["m_columns"][] = "Solicitud CDP";
$proto59["m_columns"][] = "Compromisos";
$proto59["m_columns"][] = "Cuentas por Pagar";
$proto59["m_columns"][] = "Obligaciones";
$proto59["m_columns"][] = "Ordenes de Pago";
$proto59["m_columns"][] = "Reintegros";
$proto59["m_columns"][] = "FECHA_ACTUALIZACION";
$obj = new SQLTable($proto59);

$proto58["m_table"] = $obj;
$proto58["m_sql"] = "`007_cdp`";
$proto58["m_alias"] = "";
$proto58["m_srcTableName"] = "007_cdp";
$proto60=array();
$proto60["m_sql"] = "";
