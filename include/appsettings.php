...
$custom_labels["Spanish"] = array();
	$custom_labels["Spanish"]['SESSION_EXPIRED_COMMENT'] = "Por razones de seguridad, su sesión se cerrará en %seconds% segundos a menos que decida continuar.";
	$custom_labels["Spanish"]['EXPORT_RESULTS'] = "Generar archivo para Publicación en SECOP";
...
$projectBuildKey = "2451_1713529580";
$wizardBuildKey = "41619";
$projectBuildNumber = "2451";
...
$tableCaptions["Spanish"]["q_recursos_gestor_c1"] = "Programar recursos";
$tableCaptions["Spanish"]["paa_master"] = "Publicaciones en SECOP";
$tableCaptions["Spanish"]["global_unspsc"] = "Código UNSPSC";
...
$tableCaptions["Spanish"]["paa_master_f"] = "Publicaciones en SECOP";
$tableCaptions["Spanish"]["q_ctrl_saldos_act_paa_1"] = "Q Ctrl Saldos Act Paa 1";
$tableCaptions["Spanish"]["paa_master_stat_0"] = "Bandeja OAP";
$tableCaptions["Spanish"]["q_info_inversion"] = "Ficha técnica inversión";
$tableCaptions["Spanish"]["paa_master_msj"] = "Mensajería interna";
...
$tableCaptions["Spanish"]["000_global_fun"] = "Funcionamiento";
$tableCaptions["Spanish"]["001_rubro_fun"] = "RUBRO";
$tableCaptions["Spanish"]["002_producto_fun"] = "PRODUCTO";
$tableCaptions["Spanish"]["q_recursos_gestor_f_all"] = "Funcionamiento | Entidad";
$tableCaptions["Spanish"]["dependencia"] = "Dependencia";
$tableCaptions["Spanish"]["paa_master_stat_1"] = "Paa Master Stat 1";
$tableCaptions["Spanish"]["q_info_funcionamiento"] = "Ficha técnica funcionamiento";
$tableCaptions["Spanish"]["q_info_paa_secgen_report_c"] = "Q Info Paa Secgen Report C";
$tableCaptions["Spanish"]["q_info_paa_secgen_report_f"] = "Q Info Paa Secgen Report F";
$tableCaptions["Spanish"]["paa_master_stat_2"] = "En revisión";
$tableCaptions["Spanish"]["paa_master_integrado"] = "Paa Master Integrado";
$tableCaptions["Spanish"]["tparam_publicarsecop"] = "Tparam Publicarsecop";
$tableCaptions["Spanish"]["q_paa_integrados"] = "Publicaciones PAA | Contratos integrados";
$tableCaptions["Spanish"]["q_informe_export_secop"] = "Q Informe Export Secop";
$tableCaptions["Spanish"]["q_informe_export_secop_no_aprobadas"] = "Q Informe Export Secop No Aprobadas";
$tableCaptions["Spanish"]["paa_master_admin"] = "Paa Master Admin";
$tableCaptions["Spanish"]["paa_master_stat_6"] = "No aprobadas | Devueltas | PAA";
$tableCaptions["Spanish"]["q_ctrl_saldo_0000c_Chart"] = "Inversión";
$tableCaptions["Spanish"]["q_ctrl_saldo_0000f_Chart"] = "Funcionamiento";
$tableCaptions["Spanish"]["Dashboard"] = "Dashboard";
$tableCaptions["Spanish"]["q_ctrl_saldo_0001c"] = "Detalle Inversión";
$tableCaptions["Spanish"]["q_ctrl_saldo_0001f"] = "Detalle Funcionamiento";
$tableCaptions["Spanish"]["q_seg_prog_inversion_x_rubro_001"] = "Inversion";
$tableCaptions["Spanish"]["q_info_paa"] = "Solicitudes";
$tableCaptions["Spanish"]["q_seg_prog_funcionamiento_001"] = "Funcionamiento";
$tableCaptions["Spanish"]["q_info_paa_f"] = "Q Info Paa F";
$tableCaptions["Spanish"]["q_seg_prog_funcionamiento_001_Chart"] = "Q Seg Prog Funcionamiento 001 Chart";
$tableCaptions["Spanish"]["q_seg_prog_inversion_x_rubro_001_Chart"] = "Q Seg Prog Inversion X Rubro 001 Chart";
$tableCaptions["Spanish"]["q_ctrl_saldo_00021c"] = "Q Ctrl Saldo 00021c";
$tableCaptions["Spanish"]["tparam_patrimonios"] = "Tparam Patrimonios";
$tableCaptions["Spanish"]["q_reporte_oaps_000_Report"] = "Q Reporte Oaps 000 Report";
$tableCaptions["Spanish"]["q_seg_prog_inversion_001"] = "Q Seg Prog Inversion 001";
$tableCaptions["Spanish"]["paa_master_stat_3"] = "Aprobadas para publicar en SECOP";
$tableCaptions["Spanish"]["paa_master_stat_4_c"] = "Paa Master Stat 4 C";
$tableCaptions["Spanish"]["paa_master_pscdp_c"] = "Solicitar CDP";
$tableCaptions["Spanish"]["global_estado_scdp"] = "Global Estado Scdp";
$tableCaptions["Spanish"]["global_operacion"] = "Global Operacion";
$tableCaptions["Spanish"]["paa_master_modifica"] = "Modificaciones";
$tableCaptions["Spanish"]["paa_master_stat_4_f"] = "Paa Master Stat 4 F";
$tableCaptions["Spanish"]["paa_master_pscdp_f"] = "Solicitar CDP";
$tableCaptions["Spanish"]["paa_master_pscdp_0"] = "Solicitud de CDP";
$tableCaptions["Spanish"]["paa_master_pscdp_1"] = "Paa Master Pscdp 1";
$tableCaptions["Spanish"]["paa_master_modifica_0"] = "Paa Master Modifica 0";
$tableCaptions["Spanish"]["paa_master_info"] = "Paa Master Info";
$tableCaptions["Spanish"]["paa_master_stat_4_c_integrado"] = "Paa Master Stat 4 C Integrado";
$tableCaptions["Spanish"]["paa_master_stat_4_f_integrado"] = "Paa Master Stat 4 F Integrado";
$tableCaptions["Spanish"]["002_producto_mod"] = "Solicitud de modificación";
$tableCaptions["Spanish"]["tparam_tipomod"] = "Tparam Tipomod";
$tableCaptions["Spanish"]["002_producto_m"] = "Presupuesto asignado";
$tableCaptions["Spanish"]["tparam_mod_estado"] = "Tparam Mod Estado";
$tableCaptions["Spanish"]["002_producto_mod_oap"] = "Gestionar solicitudes de modificación";
$tableCaptions["Spanish"]["002_producto_m_oap"] = "Gestionar";
$tableCaptions["Spanish"]["paa_master_pscdp_00"] = "Paa Master Pscdp 00";
$tableCaptions["Spanish"]["scdp_event_type"] = "Estado de solicitud";
$tableCaptions["Spanish"]["scdp_event_type_actividad"] = "Usuarios asociados";
$tableCaptions["Spanish"]["scdp_tracking"] = "Línea de tiempo";
$tableCaptions["Spanish"]["paa_master_stat_0f"] = "Paa Master Stat 0f";
$tableCaptions["Spanish"]["global_uc"] = "Global Uc";
$tableCaptions["Spanish"]["global_paa_nopaa"] = "Global Paa Nopaa";
$tableCaptions["Spanish"]["q_recursos_gestor_f"] = "Funcionamiento";
$tableCaptions["Spanish"]["tparam_tipo_ct_000"] = "Tparam Tipo Ct 000";
$tableCaptions["Spanish"]["tparam_tipo_ct_002"] = "Tipo de contrato";
$tableCaptions["Spanish"]["tparam_tipo_ct_001"] = "Tparam Tipo Ct 001";
$tableCaptions["Spanish"]["tparam_vigencia"] = "Tparam Vigencia";
$tableCaptions["Spanish"]["paa_master_ci"] = "Integrados";
$tableCaptions["Spanish"]["global_modalidad"] = "Global Modalidad";
$tableCaptions["Spanish"]["q_recursos_gestor_c2"] = "Recursos asignados";
$tableCaptions["Spanish"]["q_recursos_gestor_f2"] = "Recursos asignados";
$tableCaptions["Spanish"]["nopaa_master_c"] = "Solicitud NO PAA";
$tableCaptions["Spanish"]["Tablero_01"] = "Tablero 01";
$tableCaptions["Spanish"]["nopaa_master_f"] = "Solicitud NO PAA";
$tableCaptions["Spanish"]["q_ctrl_saldos_prod_paa_1"] = "Q Ctrl Saldos Prod Paa 1";
$tableCaptions["Spanish"]["nopaa_master_ci"] = "Solicitud NO PAA Integrado";
$tableCaptions["Spanish"]["nopaa_master_fi"] = "Solicitud NO PAA Integrado";
$tableCaptions["Spanish"]["q_info_nopaa_integrado"] = "Rubros asociados";
$tableCaptions["Spanish"]["paa_master_pscdp_integrado"] = "Paa Master Pscdp Integrado";
$tableCaptions["Spanish"]["global_tipo_cdp"] = "Global Tipo Cdp";
$tableCaptions["Spanish"]["nopaa_master_f_s5"] = "NOPAA | Funcionamiento";
$tableCaptions["Spanish"]["nopaa_master_c_s5"] = "NOPAA | Inversión";
$tableCaptions["Spanish"]["paa_master_pscdp_c_nopaa"] = "Paa Master Pscdp C Nopaa";
$tableCaptions["Spanish"]["paa_master_pscdp_f_nopaa"] = "Paa Master Pscdp F Nopaa";
$tableCaptions["Spanish"]["nopaa_master"] = "Nopaa Master";
$tableCaptions["Spanish"]["q_info_paa_cdp_int"] = "Q Info Paa Cdp Int";
$tableCaptions["Spanish"]["nopaa_master_c_cdp_int"] = "Nopaa Master C Cdp Int";
$tableCaptions["Spanish"]["nopaa_master_f_cdp_int"] = "Solicitud CDP Integrado";
$tableCaptions["Spanish"]["nopaa_master_admin"] = "Nopaa Master Admin";
$tableCaptions["Spanish"]["q_info_actividad"] = "Q Info Actividad";
$tableCaptions["Spanish"]["q_info_producto"] = "Q Info Producto";
$tableCaptions["Spanish"]["nopaa_master_stat_0"] = "Nopaa Master Stat 0";
$tableCaptions["Spanish"]["nopaa_master_c_s5i"] = "Nopaa Master C S5i";
$tableCaptions["Spanish"]["nopaa_master_f_s5i"] = "Funcionamiento | Integrado";
$tableCaptions["Spanish"]["q_contrato_paa"] = "Contratos";
$tableCaptions["Spanish"]["q_001_dashboard"] = "Detalle contrato";
$tableCaptions["Spanish"]["global_fecha_actualiza_siif"] = "Global Fecha Actualiza Siif";
$tableCaptions["Spanish"]["009_ep_agregada"] = "009 Ep Agregada";
$tableCaptions["Spanish"]["010_ep_desagregada"] = "10 EP";
$tableCaptions["Spanish"]["007_cdp"] = "007 Cdp";
$tableCaptions["Spanish"]["006_compromisos"] = "006 Compromisos";
$tableCaptions["Spanish"]["011_obligaciones"] = "011 Obligaciones";
$tableCaptions["Spanish"]["012_odp"] = "012 Odp";
$tableCaptions["Spanish"]["contractor_master"] = "Contractor Master";
$tableCaptions["Spanish"]["q_ep_000_Chart"] = "Q Ep 000 Chart";
$tableCaptions["Spanish"]["000_global_sad"] = "000 Global Sad";
$tableCaptions["Spanish"]["001_rubro_sad"] = "001 Rubro Sad";
$tableCaptions["Spanish"]["002_producto_sad"] = "002 Producto Sad";
$tableCaptions["Spanish"]["tparam_fuente_siif"] = "Tparam Fuente Siif";
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$page_titles[GLOBAL_PAGES_SHORT]["Spanish"]["login"] = "Planeación y Gestión";
}
