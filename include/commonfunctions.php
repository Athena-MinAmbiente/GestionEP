...
function checkTableName($shortTName )
{
	...
	if ("global_users" == $shortTName )
		return true;
	if ("001_rubro" == $shortTName )
		return true;
	if ("002_producto" == $shortTName )
		return true;
	if ("dependencias_001" == $shortTName )
		return true;
	if ("tparam_fuente" == $shortTName )
		return true;
	if ("003_actividad" == $shortTName )
		return true;
	if ("tparam_uej" == $shortTName )
		return true;
	if ("000_global" == $shortTName )
		return true;
	if ("q_recursos_gestor_c" == $shortTName )
		return true;
	if ("q_recursos_gestor_c1" == $shortTName )
		return true;
	if ("paa_master" == $shortTName )
		return true;
	if ("global_unspsc" == $shortTName )
		return true;
	if ("global_meses" == $shortTName )
		return true;
	if ("global_duracion" == $shortTName )
		return true;
	if ("global_fuenterec" == $shortTName )
		return true;
	if ("global_vf" == $shortTName )
		return true;
	if ("global_estvf" == $shortTName )
		return true;
	if ("global_ubicacion" == $shortTName )
		return true;
	if ("global_estado" == $shortTName )
		return true;
	if ("paa_master_f" == $shortTName )
		return true;
	if ("q_ctrl_saldos_act_paa_1" == $shortTName )
		return true;
	if ("paa_master_stat_0" == $shortTName )
		return true;
	if ("q_info_inversion" == $shortTName )
		return true;
	if ("paa_master_msj" == $shortTName )
		return true;
	if ("global_vigencia" == $shortTName )
		return true;
	if ("global_estado_mod" == $shortTName )
		return true;
	if ("tparam_estado" == $shortTName )
		return true;
	if ("000_global_fun" == $shortTName )
		return true;
	if ("001_rubro_fun" == $shortTName )
		return true;
	if ("002_producto_fun" == $shortTName )
		return true;
	if ("q_recursos_gestor_f_all" == $shortTName )
		return true;
	if ("dependencia" == $shortTName )
		return true;
	if ("paa_master_stat_1" == $shortTName )
		return true;
	if ("q_info_funcionamiento" == $shortTName )
		return true;
	if ("q_info_paa_secgen_report_c" == $shortTName )
		return true;
	if ("q_info_paa_secgen_report_f" == $shortTName )
		return true;
	if ("paa_master_stat_2" == $shortTName )
		return true;
	if ("paa_master_integrado" == $shortTName )
		return true;
	if ("tparam_publicarsecop" == $shortTName )
		return true;
	if ("q_paa_integrados" == $shortTName )
		return true;
	if ("q_informe_export_secop" == $shortTName )
		return true;
	if ("q_informe_export_secop_no_aprobadas" == $shortTName )
		return true;
	if ("paa_master_admin" == $shortTName )
		return true;
	if ("paa_master_stat_6" == $shortTName )
		return true;
	if ("q_ctrl_saldo_0000c_chart" == $shortTName )
		return true;
	if ("q_ctrl_saldo_0000f_chart" == $shortTName )
		return true;
	if ("dashboard" == $shortTName )
		return true;
	if ("q_ctrl_saldo_0001c" == $shortTName )
		return true;
	if ("q_ctrl_saldo_0001f" == $shortTName )
		return true;
	if ("q_seg_prog_inversion_x_rubro_001" == $shortTName )
		return true;
	if ("q_info_paa" == $shortTName )
		return true;
	if ("q_seg_prog_funcionamiento_001" == $shortTName )
		return true;
	if ("q_info_paa_f" == $shortTName )
		return true;
	if ("q_seg_prog_funcionamiento_001_chart" == $shortTName )
		return true;
	if ("q_seg_prog_inversion_x_rubro_001_chart" == $shortTName )
		return true;
	if ("q_ctrl_saldo_00021c" == $shortTName )
		return true;
	if ("tparam_patrimonios" == $shortTName )
		return true;
	if ("q_reporte_oaps_000_report" == $shortTName )
		return true;
	if ("q_seg_prog_inversion_001" == $shortTName )
		return true;
	if ("paa_master_stat_3" == $shortTName )
		return true;
	if ("paa_master_stat_4_c" == $shortTName )
		return true;
	if ("paa_master_pscdp_c" == $shortTName )
		return true;
	if ("global_estado_scdp" == $shortTName )
		return true;
	if ("global_operacion" == $shortTName )
		return true;
	if ("paa_master_modifica" == $shortTName )
		return true;
	if ("paa_master_stat_4_f" == $shortTName )
		return true;
	if ("paa_master_pscdp_f" == $shortTName )
		return true;
	if ("paa_master_pscdp_0" == $shortTName )
		return true;
	if ("paa_master_pscdp_1" == $shortTName )
		return true;
	if ("paa_master_modifica_0" == $shortTName )
		return true;
	if ("paa_master_info" == $shortTName )
		return true;
	if ("paa_master_stat_4_c_integrado" == $shortTName )
		return true;
	if ("paa_master_stat_4_f_integrado" == $shortTName )
		return true;
	if ("002_producto_mod" == $shortTName )
		return true;
	if ("tparam_tipomod" == $shortTName )
		return true;
	if ("002_producto_m" == $shortTName )
		return true;
	if ("tparam_mod_estado" == $shortTName )
		return true;
	if ("002_producto_mod_oap" == $shortTName )
		return true;
	if ("002_producto_m_oap" == $shortTName )
		return true;
	if ("paa_master_pscdp_00" == $shortTName )
		return true;
	if ("scdp_event_type" == $shortTName )
		return true;
	if ("scdp_event_type_actividad" == $shortTName )
		return true;
	if ("scdp_tracking" == $shortTName )
		return true;
	if ("paa_master_stat_0f" == $shortTName )
		return true;
	if ("global_uc" == $shortTName )
		return true;
	if ("global_paa_nopaa" == $shortTName )
		return true;
	if ("q_recursos_gestor_f" == $shortTName )
		return true;
	...
	if ("tparam_vigencia" == $shortTName )
		return true;
	if ("paa_master_ci" == $shortTName )
		return true;
	if ("global_modalidad" == $shortTName )
		return true;
	if ("q_recursos_gestor_c2" == $shortTName )
		return true;
	if ("q_recursos_gestor_f2" == $shortTName )
		return true;
	if ("nopaa_master_c" == $shortTName )
		return true;
	if ("tablero_01" == $shortTName )
		return true;
	if ("nopaa_master_f" == $shortTName )
		return true;
	if ("q_ctrl_saldos_prod_paa_1" == $shortTName )
		return true;
	if ("nopaa_master_ci" == $shortTName )
		return true;
	if ("nopaa_master_fi" == $shortTName )
		return true;
	if ("q_info_nopaa_integrado" == $shortTName )
		return true;
	if ("paa_master_pscdp_integrado" == $shortTName )
		return true;
	if ("global_tipo_cdp" == $shortTName )
		return true;
	if ("nopaa_master_f_s5" == $shortTName )
		return true;
	if ("nopaa_master_c_s5" == $shortTName )
		return true;
	if ("paa_master_pscdp_c_nopaa" == $shortTName )
		return true;
	if ("paa_master_pscdp_f_nopaa" == $shortTName )
		return true;
	if ("nopaa_master" == $shortTName )
		return true;
	if ("q_info_paa_cdp_int" == $shortTName )
		return true;
	if ("nopaa_master_c_cdp_int" == $shortTName )
		return true;
	if ("nopaa_master_f_cdp_int" == $shortTName )
		return true;
	if ("nopaa_master_admin" == $shortTName )
		return true;
	if ("q_info_actividad" == $shortTName )
		return true;
	if ("q_info_producto" == $shortTName )
		return true;
	if ("nopaa_master_stat_0" == $shortTName )
		return true;
	if ("nopaa_master_c_s5i" == $shortTName )
		return true;
	if ("nopaa_master_f_s5i" == $shortTName )
		return true;
	if ("q_contrato_paa" == $shortTName )
		return true;
	if ("q_001_dashboard" == $shortTName )
		return true;
	if ("global_fecha_actualiza_siif" == $shortTName )
		return true;
	if ("009_ep_agregada" == $shortTName )
		return true;
	if ("010_ep_desagregada" == $shortTName )
		return true;
	if ("007_cdp" == $shortTName )
		return true;
	if ("006_compromisos" == $shortTName )
		return true;
	if ("011_obligaciones" == $shortTName )
		return true;
	if ("012_odp" == $shortTName )
		return true;
	if ("contractor_master" == $shortTName )
		return true;
	if ("q_ep_000_chart" == $shortTName )
		return true;
	if ("000_global_sad" == $shortTName )
		return true;
	if ("001_rubro_sad" == $shortTName )
		return true;
	if ("002_producto_sad" == $shortTName )
		return true;
	if ("tparam_fuente_siif" == $shortTName )
		return true;
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_ctrl_saldos_act_paa_1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_ctrl_saldos_act_paa_1";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_stat_0");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_stat_0";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_info_inversion");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_info_inversion";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_msj");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("000_global_fun");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("001_rubro_fun");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("002_producto_fun");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="002_producto_fun";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_recursos_gestor_f_all");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_recursos_gestor_f_all";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_stat_1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_stat_1";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_info_funcionamiento");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_info_funcionamiento";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_info_paa_secgen_report_c");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_info_paa_secgen_report_c";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_info_paa_secgen_report_f");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_info_paa_secgen_report_f";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_stat_2");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_stat_2";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_integrado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_integrado";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_publicarsecop");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tparam_publicarsecop";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_paa_integrados");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_paa_integrados";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_informe_export_secop");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_informe_export_secop";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_informe_export_secop_no_aprobadas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_informe_export_secop_no_aprobadas";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_stat_6");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_stat_6";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_ctrl_saldo_0000c Chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_ctrl_saldo_0000c Chart";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_ctrl_saldo_0000f Chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_ctrl_saldo_0000f Chart";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_ctrl_saldo_0001c");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_ctrl_saldo_0001c";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_ctrl_saldo_0001f");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_ctrl_saldo_0001f";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_seg_prog_inversion_x_rubro_001");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_seg_prog_inversion_x_rubro_001";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_info_paa");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_seg_prog_funcionamiento_001");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_seg_prog_funcionamiento_001";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_info_paa_f");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_seg_prog_funcionamiento_001 Chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_seg_prog_funcionamiento_001 Chart";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_seg_prog_inversion_x_rubro_001 Chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_seg_prog_inversion_x_rubro_001 Chart";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_ctrl_saldo_00021c");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_ctrl_saldo_00021c";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_patrimonios");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tparam_patrimonios";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_reporte_oaps_000 Report");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_reporte_oaps_000 Report";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_seg_prog_inversion_001");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_seg_prog_inversion_001";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_stat_3");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_stat_3";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_stat_4_c");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_stat_4_c";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_pscdp_c");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_pscdp_c";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_stat_4_f");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_stat_4_f";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_pscdp_f");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_pscdp_f";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_pscdp_0");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_pscdp_0";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_pscdp_1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_pscdp_1";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_modifica_0");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_modifica_0";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_info");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_stat_4_c_integrado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_stat_4_c_integrado";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_stat_4_f_integrado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_stat_4_f_integrado";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("002_producto_mod");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="002_producto_mod";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_tipomod");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("002_producto_m");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_mod_estado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tparam_mod_estado";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("002_producto_mod_oap");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="002_producto_mod_oap";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("002_producto_m_oap");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="002_producto_m_oap";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_pscdp_00");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_pscdp_00";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("scdp_event_type");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("scdp_event_type_actividad");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="scdp_event_type_actividad";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("scdp_tracking");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_stat_0f");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_stat_0f";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_uc");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_recursos_gestor_f");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_recursos_gestor_f";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_ci");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_recursos_gestor_c2");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_recursos_gestor_c2";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_recursos_gestor_f2");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_recursos_gestor_f2";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("nopaa_master_c");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Tablero_01");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("nopaa_master_f");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_ctrl_saldos_prod_paa_1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_ctrl_saldos_prod_paa_1";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("nopaa_master_ci");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("nopaa_master_fi");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_info_nopaa_integrado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_info_nopaa_integrado";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_pscdp_integrado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_pscdp_integrado";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_tipo_cdp");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("nopaa_master_f_s5");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="nopaa_master_f_s5";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("nopaa_master_c_s5");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="nopaa_master_c_s5";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_pscdp_c_nopaa");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_pscdp_c_nopaa";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_pscdp_f_nopaa");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_pscdp_f_nopaa";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("nopaa_master");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_info_paa_cdp_int");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_info_paa_cdp_int";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("nopaa_master_c_cdp_int");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="nopaa_master_c_cdp_int";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("nopaa_master_f_cdp_int");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="nopaa_master_f_cdp_int";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("nopaa_master_admin");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="nopaa_master_admin";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_info_actividad");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_info_actividad";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_info_producto");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("nopaa_master_stat_0");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="nopaa_master_stat_0";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("nopaa_master_c_s5i");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="nopaa_master_c_s5i";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("nopaa_master_f_s5i");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="nopaa_master_f_s5i";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_contrato_paa");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_fecha_actualiza_siif");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="global_fecha_actualiza_siif";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("009_ep_agregada");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("010_ep_desagregada");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="010_ep_desagregada";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("006_compromisos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("011_obligaciones");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="011_obligaciones";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("012_odp");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_ep_000 Chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("000_global_sad");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("001_rubro_sad");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("002_producto_sad");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="002_producto_sad";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_fuente_siif");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tparam_fuente_siif";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
...
{
	if($shorttable=="q_ctrl_saldo_0000c_chart")
		return "Combined";
	if($shorttable=="q_ctrl_saldo_0000f_chart")
		return "Combined";
	if($shorttable=="q_seg_prog_funcionamiento_001_chart")
		return "Combined";
	if($shorttable=="q_seg_prog_inversion_x_rubro_001_chart")
		return "Combined";
	if($shorttable=="q_ep_000_chart")
		return "2DColumn";
	return "";
}
...
//	default permissions
	...
	if( $table=="q_ctrl_saldos_act_paa_1" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_stat_0" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_info_inversion" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_msj" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="000_global_fun" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="001_rubro_fun" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="002_producto_fun" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_recursos_gestor_f_all" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="paa_master_stat_1" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_info_funcionamiento" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_info_paa_secgen_report_c" )
	{
//	default permissions
		return "SP".$extraPerm;
	}
	if( $table=="q_info_paa_secgen_report_f" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_stat_2" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_integrado" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tparam_publicarsecop" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_paa_integrados" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_informe_export_secop" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_informe_export_secop_no_aprobadas" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="paa_master_stat_6" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_ctrl_saldo_0000c Chart" )
	{
//	default permissions
		return "S".$extraPerm;
	}
	if( $table=="q_ctrl_saldo_0000f Chart" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="q_ctrl_saldo_0001c" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_ctrl_saldo_0001f" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_seg_prog_inversion_x_rubro_001" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="q_seg_prog_funcionamiento_001" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_info_paa_f" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_seg_prog_funcionamiento_001 Chart" )
	{
//	default permissions
		return "S".$extraPerm;
	}
	if( $table=="q_seg_prog_inversion_x_rubro_001 Chart" )
	{
//	default permissions
		return "S".$extraPerm;
	}
	if( $table=="q_ctrl_saldo_00021c" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tparam_patrimonios" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_reporte_oaps_000 Report" )
	{
//	default permissions
		return "SP".$extraPerm;
	}
	if( $table=="q_seg_prog_inversion_001" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_stat_3" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_stat_4_c" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_pscdp_c" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="paa_master_stat_4_f" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_pscdp_f" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_pscdp_0" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_pscdp_1" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_modifica_0" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_info" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_stat_4_c_integrado" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_stat_4_f_integrado" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="002_producto_mod" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tparam_tipomod" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="002_producto_m" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tparam_mod_estado" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="002_producto_mod_oap" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="002_producto_m_oap" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_pscdp_00" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="scdp_event_type" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="scdp_event_type_actividad" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="scdp_tracking" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_stat_0f" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="q_recursos_gestor_c2" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_recursos_gestor_f2" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="nopaa_master_c" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="nopaa_master_f" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_ctrl_saldos_prod_paa_1" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="nopaa_master_ci" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="nopaa_master_fi" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_info_nopaa_integrado" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_pscdp_integrado" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="global_tipo_cdp" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="nopaa_master_f_s5" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="nopaa_master_c_s5" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_pscdp_c_nopaa" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_pscdp_f_nopaa" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="nopaa_master" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_info_paa_cdp_int" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="nopaa_master_c_cdp_int" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="nopaa_master_f_cdp_int" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="nopaa_master_admin" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_info_actividad" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_info_producto" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="nopaa_master_stat_0" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="nopaa_master_c_s5i" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="nopaa_master_f_s5i" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_contrato_paa" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="global_fecha_actualiza_siif" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="009_ep_agregada" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="010_ep_desagregada" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="006_compromisos" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="011_obligaciones" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="q_ep_000 Chart" )
	{
//	default permissions
		return "S".$extraPerm;
	}
	if( $table=="000_global_sad" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="001_rubro_sad" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="002_producto_sad" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tparam_fuente_siif" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
