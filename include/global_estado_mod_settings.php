...
$tdataglobal_estado_mod[".pagesByType"] = my_json_decode( "{\"search\":[\"search\"]}" );
$tdataglobal_estado_mod[".originalPagesByType"] = $tdataglobal_estado_mod[".pagesByType"];
$tdataglobal_estado_mod[".pages"] = types2pages( my_json_decode( "{\"search\":[\"search\"]}" ) );
$tdataglobal_estado_mod[".originalPages"] = $tdataglobal_estado_mod[".pages"];
$tdataglobal_estado_mod[".defaultPages"] = my_json_decode( "{\"search\":\"search\"}" );
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelsglobal_estado_mod["Spanish"]["not_mail"] = "Not Mail";
	$fieldToolTipsglobal_estado_mod["Spanish"]["not_mail"] = "";
	$placeHoldersglobal_estado_mod["Spanish"]["not_mail"] = "";
...
$tdataglobal_estado_mod[".connId"] = "mincit_global_20x_at_127_0_0_1";
...
//$tdataglobal_estado_mod[".listAjax"] = false;
	...
	$tdataglobal_estado_mod[".audit"] = true;

	$tdataglobal_estado_mod[".locking"] = true;
...
$tdataglobal_estado_mod[".badgeColor"] = "5F9EA0";
...
$tdataglobal_estado_mod[".googleLikeFields"][] = "not_mail";
...
$tdataglobal_estado_mod[".sqlHead"] = "SELECT status_mod_id,  	status_mod_name,  	not_mail";
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "global_estado_mod";
	$fdata["Label"] = GetFieldLabel("global_estado_mod","not_mail");
	$fdata["FieldType"] = 200;
...
//end of Filters settings
	...
	$tdataglobal_estado_mod["not_mail"] = $fdata;
		$tdataglobal_estado_mod[".searchableFields"][] = "not_mail";
...
changeTextControlsToDate( "global_estado_mod" );
...
$proto0["m_strFieldList"] = "status_mod_id,  	status_mod_name,  	not_mail";
...
$proto12["m_link"] = "SQLL_MAIN";
			$proto13=array();
$proto13["m_strName"] = "global_estado_mod";
$proto13["m_srcTableName"] = "global_estado_mod";
$proto13["m_columns"] = array();
$proto13["m_columns"][] = "status_mod_id";
$proto13["m_columns"][] = "status_mod_name";
$proto13["m_columns"][] = "not_mail";
$obj = new SQLTable($proto13);

$proto12["m_table"] = $obj;
$proto12["m_sql"] = "global_estado_mod";
$proto12["m_alias"] = "";
$proto12["m_srcTableName"] = "global_estado_mod";
$proto14=array();
$proto14["m_sql"] = "";
