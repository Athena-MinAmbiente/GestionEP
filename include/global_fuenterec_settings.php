...
$tdataglobal_fuenterec[".pagesByType"] = my_json_decode( "{\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"]}" );
$tdataglobal_fuenterec[".originalPagesByType"] = $tdataglobal_fuenterec[".pagesByType"];
$tdataglobal_fuenterec[".pages"] = types2pages( my_json_decode( "{\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"]}" ) );
$tdataglobal_fuenterec[".originalPages"] = $tdataglobal_fuenterec[".pages"];
$tdataglobal_fuenterec[".defaultPages"] = my_json_decode( "{\"masterlist\":\"masterlist\",\"masterprint\":\"masterprint\"}" );
...
$tdataglobal_fuenterec[".connId"] = "mincit_global_20x_at_127_0_0_1";
...
//$tdataglobal_fuenterec[".listAjax"] = false;
	...
	$tdataglobal_fuenterec[".audit"] = true;

	$tdataglobal_fuenterec[".locking"] = true;
...
changeTextControlsToDate( "global_fuenterec" );
...
//	paa_master_stat_0f
	...
	$detailsTablesData["global_fuenterec"][$dIndex] = $detailsParam;

	
		$detailsTablesData["global_fuenterec"][$dIndex]["masterKeys"] = array();

	$detailsTablesData["global_fuenterec"][$dIndex]["masterKeys"][]="COD_FUENTE";

				$detailsTablesData["global_fuenterec"][$dIndex]["detailKeys"] = array();

	$detailsTablesData["global_fuenterec"][$dIndex]["detailKeys"][]="FUENTE_RECURSOS";
//endif
