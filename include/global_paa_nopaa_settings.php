...
$tdataglobal_paa_nopaa[".pagesByType"] = my_json_decode( "{\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"]}" );
$tdataglobal_paa_nopaa[".originalPagesByType"] = $tdataglobal_paa_nopaa[".pagesByType"];
$tdataglobal_paa_nopaa[".pages"] = types2pages( my_json_decode( "{\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"]}" ) );
$tdataglobal_paa_nopaa[".originalPages"] = $tdataglobal_paa_nopaa[".pages"];
$tdataglobal_paa_nopaa[".defaultPages"] = my_json_decode( "{\"masterlist\":\"masterlist\",\"masterprint\":\"masterprint\"}" );
...
$tdataglobal_paa_nopaa[".connId"] = "mincit_global_20x_at_127_0_0_1";
...
//$tdataglobal_paa_nopaa[".listAjax"] = false;
	...
	$tdataglobal_paa_nopaa[".audit"] = true;

	$tdataglobal_paa_nopaa[".locking"] = true;
...
$tdataglobal_paa_nopaa[".badgeColor"] = "9ACD32";
...
changeTextControlsToDate( "global_paa_nopaa" );
