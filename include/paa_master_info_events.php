 ...
 */
 ...
 class eventclass_paa_master_info  extends eventsBase
{
...
$msg="<p>Buen dia,  se ha registrado una nueva solicitud para publicación en SECOP con el número PAA ID: <strong>".$values['PAA_ID']."</strong> para su revisión y aprobación, por favor revise su bandeja de entrada en el módulo de Planeación y Gestión para más detalle.</p>
<br />";
$subject="Nueva solicitud PAA ID: ".$values['PAA_ID'];
