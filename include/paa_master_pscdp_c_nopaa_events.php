 ...
 */
 ...
 class eventclass_paa_master_pscdp_c_nopaa  extends eventsBase
{
...
$data['sol_fecha'] = $values['SOL_FECHA'];
$data['user_from'] = $values['USER_REG'];
$data['user_to'] = $values['sys_user'];
$data['not_mail'] = $values['NOT_MAIL'];
$data['not_msg'] = $values['OBS'];
DB::Insert("dbgpaa.scdp_tracking", $data );
