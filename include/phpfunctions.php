...
{
	$value = "";
				if($table=="paa_master_pscdp_c" && $field=="ATTACH_A")
	{
		;
		return $value;
	}
				if($table=="paa_master_pscdp_f" && $field=="ATTACH_A")
	{
		;
		return $value;
	}
				if($table=="paa_master_pscdp_f" && $field=="DOCUMENTO_CDP_SIIF")
	{
		;
		return $value;
	}
				if($table=="paa_master_pscdp_0" && $field=="DOCUMENTO_SCDP_SIIF")
	{
		;
		return $value;
	}
				if($table=="paa_master_pscdp_0" && $field=="ATTACH_A")
	{
		;
		return $value;
	}
				if($table=="paa_master_pscdp_1" && $field=="DOCUMENTO_SCDP_SIIF")
	{
		;
		return $value;
	}
				if($table=="paa_master_pscdp_1" && $field=="DOCUMENTO_CDP_SIIF")
	{
		;
		return $value;
	}
				if($table=="paa_master_pscdp_1" && $field=="ATTACH_A")
	{
		;
		return $value;
	}
				if($table=="002_producto_mod" && $field=="mod_file")
	{
		;
		return $value;
	}
				if($table=="002_producto_mod_oap" && $field=="mod_file")
	{
		;
		return $value;
	}
				if($table=="paa_master_pscdp_00" && $field=="DOCUMENTO_SCDP_SIIF")
	{
		;
		return $value;
	}
				if($table=="paa_master_pscdp_00" && $field=="ATTACH_A")
	{
		;
		return $value;
	}
				if($table=="paa_master_pscdp_integrado" && $field=="ATTACH_A")
	{
		;
		return $value;
	}
				if($table=="paa_master_pscdp_c_nopaa" && $field=="ATTACH_A")
	{
		;
		return $value;
	}
				if($table=="paa_master_pscdp_f_nopaa" && $field=="ATTACH_A")
	{
		;
		return $value;
	}
				if($table=="paa_master_pscdp_f_nopaa" && $field=="DOCUMENTO_CDP_SIIF")
	{
		;
		return $value;
	}
...
function GetDefaultValue($field, $ptype, $table="")
{
				...
				if($table=="002_producto" && $field=="TIPO")
	{
		return 1;
				...
				if($table=="000_global" && $field=="TIPO")
	{
		return 1;
	}
				if($table=="paa_master" && $field=="FUENTE_RECURSOS")
	{
		return 1;
	}
				...
				if($table=="paa_master" && $field=="TIPOSOL")
	{
		return 1;
				...
				if($table=="paa_master" && $field=="registrado_por")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master" && $field=="PAAID_INTEGRADO")
	{
		return 1;
	}
				if($table=="paa_master" && $field=="TIPO")
	{
		return 'C';
	}
				...
				if($table=="paa_master_f" && $field=="sys_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
				...
				if($table=="paa_master_f" && $field=="registrado_por")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_f" && $field=="TIPO")
	{
		return 'A';
	}
				if($table=="paa_master_f" && $field=="PAAID_INTEGRADO")
	{
		return 1;
	}
				if($table=="paa_master_msj" && $field=="de")
	{
		return $_SESSION["sessemail"];
	}
				if($table=="000_global_fun" && $field=="TIPO")
	{
		return 2;
	}
				if($table=="001_rubro_fun" && $field=="TIPO")
	{
		return 2;
	}
				if($table=="002_producto_fun" && $field=="TIPO")
	{
		return 2;
	}
				if($table=="paa_master_integrado" && $field=="UNIDAD_CONTRATACION")
	{
		return 'PAA';
	}
				if($table=="paa_master_integrado" && $field=="RESPONSABLE_TELEFONO")
	{
		return 6067676;
	}
				if($table=="paa_master_integrado" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_integrado" && $field=="sys_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_integrado" && $field=="TIPOSOL")
	{
		return 1;
	}
				if($table=="paa_master_integrado" && $field=="registrado_por")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_integrado" && $field=="ct_integrado")
	{
		return 2;
	}
				if($table=="paa_master_admin" && $field=="UNIDAD_CONTRATACION")
	{
		return PAA;
				...
				if($table=="paa_master_admin" && $field=="RESPONSABLE_TELEFONO")
	{
		return 6067676;
	}
				if($table=="paa_master_pscdp_c" && $field=="SOL_FECHA")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_pscdp_c" && $field=="USER_REG")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_pscdp_c" && $field=="SYS_STATUS")
	{
		return 0;
	}
				...
				if($table=="paa_master_modifica" && $field=="PAAM_ST")
	{
		return 0;
				...
				if($table=="paa_master_modifica" && $field=="SYS_USER")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_modifica" && $field=="SYS_DATE")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_pscdp_f" && $field=="SOL_FECHA")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_pscdp_f" && $field=="USER_REG")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_pscdp_f" && $field=="SYS_STATUS")
	{
		return 0;
	}
				if($table=="paa_master_pscdp_0" && $field=="SYS_STATUS")
	{
		return 1;
	}
				if($table=="paa_master_pscdp_0" && $field=="USUARIO_SCDP_SIIF")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_pscdp_1" && $field=="SYS_STATUS")
	{
		return 2;
	}
				if($table=="paa_master_pscdp_1" && $field=="USUARIO_CDP_SIIF")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_modifica_0" && $field=="SYSUSER")
	{
		return $_SESSION["sessemail"];
	}
				if($table=="paa_master_modifica_0" && $field=="SYS_DATE")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_info" && $field=="UNIDAD_CONTRATACION")
	{
		return PAA;
	}
				if($table=="paa_master_info" && $field=="RESPONSABLE_TELEFONO")
	{
		return 6067676;
	}
				if($table=="002_producto_mod" && $field=="email_user")
	{
		return $_SESSION["sessemail"];
	}
				if($table=="002_producto_mod" && $field=="mod_estado")
	{
		return 1;
	}
				if($table=="002_producto_mod" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="002_producto_mod" && $field=="sys_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="002_producto_m" && $field=="TIPO")
	{
		return 1;
	}
				if($table=="002_producto_mod_oap" && $field=="mod_estado")
	{
		return 1;
	}
				if($table=="002_producto_mod_oap" && $field=="resp_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="002_producto_mod_oap" && $field=="resp_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="002_producto_m_oap" && $field=="TIPO")
	{
		return 1;
	}
				if($table=="paa_master_pscdp_00" && $field=="SYS_STATUS")
	{
		return 1;
	}
				if($table=="paa_master_pscdp_00" && $field=="USUARIO_SCDP_SIIF")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_ci" && $field=="UNIDAD_CONTRATACION")
	{
		return PAA;
	}
				if($table=="paa_master_ci" && $field=="RESPONSABLE_TELEFONO")
	{
		return 6067676;
	}
				if($table=="paa_master_ci" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_ci" && $field=="sys_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_ci" && $field=="TIPOSOL")
	{
		return 2;
	}
				if($table=="paa_master_ci" && $field=="registrado_por")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_ci" && $field=="TIPO")
	{
		return C;
	}
				if($table=="nopaa_master_c" && $field=="TIPO")
	{
		return 'C';
	}
				if($table=="nopaa_master_c" && $field=="UNIDAD_CONTRATACION")
	{
		return 'NOPAA';
	}
				if($table=="nopaa_master_c" && $field=="responsable")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_c" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_c" && $field=="registrado_por")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_c" && $field=="sys_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="nopaa_master_f" && $field=="TIPO")
	{
		return 'C';
	}
				if($table=="nopaa_master_f" && $field=="UNIDAD_CONTRATACION")
	{
		return 'NOPAA';
	}
				if($table=="nopaa_master_f" && $field=="responsable")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_f" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_f" && $field=="registrado_por")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_f" && $field=="sys_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="nopaa_master_f" && $field=="sys_status")
	{
		return 5;
	}
				if($table=="nopaa_master_ci" && $field=="TIPO")
	{
		return 'C';
	}
				if($table=="nopaa_master_ci" && $field=="UNIDAD_CONTRATACION")
	{
		return 'NOPAA';
	}
				if($table=="nopaa_master_ci" && $field=="responsable")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_ci" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_ci" && $field=="registrado_por")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_ci" && $field=="sys_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="nopaa_master_fi" && $field=="TIPO")
	{
		return 'C';
	}
				if($table=="nopaa_master_fi" && $field=="UNIDAD_CONTRATACION")
	{
		return 'NOPAA';
	}
				if($table=="nopaa_master_fi" && $field=="responsable")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_fi" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_fi" && $field=="registrado_por")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_fi" && $field=="sys_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_pscdp_integrado" && $field=="VIGENCIA")
	{
		return strftime("%Y");
	}
				if($table=="paa_master_pscdp_integrado" && $field=="SOL_FECHA")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_pscdp_integrado" && $field=="USER_REG")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_pscdp_integrado" && $field=="SYS_STATUS")
	{
		return 9;
	}
				if($table=="paa_master_pscdp_integrado" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_f_s5" && $field=="TIPO")
	{
		return 'C';
	}
				if($table=="nopaa_master_f_s5" && $field=="UNIDAD_CONTRATACION")
	{
		return 'NOPAA';
	}
				if($table=="nopaa_master_f_s5" && $field=="responsable")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_f_s5" && $field=="registrado_por")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_f_s5" && $field=="sys_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="nopaa_master_f_s5" && $field=="sys_status")
	{
		return 5;
	}
				if($table=="nopaa_master_c_s5" && $field=="TIPO")
	{
		return 'C';
	}
				if($table=="nopaa_master_c_s5" && $field=="UNIDAD_CONTRATACION")
	{
		return 'NOPAA';
	}
				if($table=="nopaa_master_c_s5" && $field=="responsable")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_c_s5" && $field=="registrado_por")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_c_s5" && $field=="sys_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_pscdp_c_nopaa" && $field=="SOL_FECHA")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_pscdp_c_nopaa" && $field=="USER_REG")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_pscdp_c_nopaa" && $field=="SYS_STATUS")
	{
		return 0;
	}
				if($table=="paa_master_pscdp_f_nopaa" && $field=="SOL_FECHA")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_pscdp_f_nopaa" && $field=="USER_REG")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_pscdp_f_nopaa" && $field=="SYS_STATUS")
	{
		return 0;
	}
				if($table=="nopaa_master_c_cdp_int" && $field=="TIPO")
	{
		return 'C';
	}
				if($table=="nopaa_master_c_cdp_int" && $field=="UNIDAD_CONTRATACION")
	{
		return 'NOPAA';
	}
				if($table=="nopaa_master_c_cdp_int" && $field=="responsable")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_c_cdp_int" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_c_cdp_int" && $field=="registrado_por")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_c_cdp_int" && $field=="sys_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="nopaa_master_f_cdp_int" && $field=="TIPO")
	{
		return 'C';
	}
				if($table=="nopaa_master_f_cdp_int" && $field=="UNIDAD_CONTRATACION")
	{
		return 'NOPAA';
	}
				if($table=="nopaa_master_f_cdp_int" && $field=="responsable")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_f_cdp_int" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_f_cdp_int" && $field=="registrado_por")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_f_cdp_int" && $field=="sys_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="nopaa_master_f_cdp_int" && $field=="CDP_INTEGRADO")
	{
		return 9;
	}
				if($table=="nopaa_master_stat_0" && $field=="sys_status")
	{
		return 5;
	}
				if($table=="nopaa_master_c_s5i" && $field=="TIPO")
	{
		return 'C';
	}
				if($table=="nopaa_master_c_s5i" && $field=="UNIDAD_CONTRATACION")
	{
		return 'NOPAA';
	}
				if($table=="nopaa_master_c_s5i" && $field=="responsable")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_c_s5i" && $field=="registrado_por")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_c_s5i" && $field=="sys_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="nopaa_master_f_s5i" && $field=="TIPO")
	{
		return 'C';
	}
				if($table=="nopaa_master_f_s5i" && $field=="UNIDAD_CONTRATACION")
	{
		return 'NOPAA';
	}
				if($table=="nopaa_master_f_s5i" && $field=="responsable")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_f_s5i" && $field=="registrado_por")
	{
		return $_SESSION["UserID"];
	}
				if($table=="nopaa_master_f_s5i" && $field=="sys_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="nopaa_master_f_s5i" && $field=="sys_status")
	{
		return 5;
	}
				if($table=="010_ep_desagregada" && $field=="FUENTE")
	{
		return 'Nación';
	}
				if($table=="000_global_sad" && $field=="TIPO")
	{
		return 3;
	}
				if($table=="001_rubro_sad" && $field=="FUENTE")
	{
		return Nación;
	}
				if($table=="001_rubro_sad" && $field=="TIPO")
	{
		return 2;
	}
				if($table=="002_producto_sad" && $field=="TIPO")
	{
		return 2;
	}
	return "";
