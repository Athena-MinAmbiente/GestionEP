...
$tdatatparam_fuente[".pagesByType"] = my_json_decode( "{\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"search\":[\"search\"]}" );
$tdatatparam_fuente[".originalPagesByType"] = $tdatatparam_fuente[".pagesByType"];
$tdatatparam_fuente[".pages"] = types2pages( my_json_decode( "{\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"search\":[\"search\"]}" ) );
$tdatatparam_fuente[".originalPages"] = $tdatatparam_fuente[".pages"];
$tdatatparam_fuente[".defaultPages"] = my_json_decode( "{\"masterlist\":\"masterlist\",\"masterprint\":\"masterprint\",\"search\":\"search\"}" );
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelstparam_fuente["Spanish"]["tipo"] = "Tipo";
	$fieldToolTipstparam_fuente["Spanish"]["tipo"] = "";
	$placeHolderstparam_fuente["Spanish"]["tipo"] = "";
...
$tdatatparam_fuente[".connId"] = "sep2_at_127_0_0_1";
...
//$tdatatparam_fuente[".listAjax"] = false;
	...
	$tdatatparam_fuente[".audit"] = true;

	$tdatatparam_fuente[".locking"] = true;
...
$tdatatparam_fuente[".googleLikeFields"][] = "tipo";
...
$tdatatparam_fuente[".sqlHead"] = "SELECT fuente_id,  	fuente_name,  	tipo";
...
//	Custom field settings
	...
	$fdata["GoodName"] = "tipo";
	$fdata["ownerTable"] = "tparam_fuente";
	$fdata["Label"] = GetFieldLabel("tparam_fuente","tipo");
	$fdata["FieldType"] = 16;
...
//end of Filters settings
	...
	$tdatatparam_fuente["tipo"] = $fdata;
		$tdatatparam_fuente[".searchableFields"][] = "tipo";
...
changeTextControlsToDate( "tparam_fuente" );
...
$proto0["m_strFieldList"] = "fuente_id,  	fuente_name,  	tipo";
...
$proto12["m_link"] = "SQLL_MAIN";
			$proto13=array();
$proto13["m_strName"] = "tparam_fuente";
$proto13["m_srcTableName"] = "tparam_fuente";
$proto13["m_columns"] = array();
$proto13["m_columns"][] = "fuente_id";
$proto13["m_columns"][] = "fuente_name";
$proto13["m_columns"][] = "tipo";
$obj = new SQLTable($proto13);

$proto12["m_table"] = $obj;
$proto12["m_sql"] = "tparam_fuente";
$proto12["m_alias"] = "";
$proto12["m_srcTableName"] = "tparam_fuente";
$proto14=array();
$proto14["m_sql"] = "";
