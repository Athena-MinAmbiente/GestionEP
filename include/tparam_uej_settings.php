...
$tdatatparam_uej[".pagesByType"] = my_json_decode( "{\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"]}" );
$tdatatparam_uej[".originalPagesByType"] = $tdatatparam_uej[".pagesByType"];
$tdatatparam_uej[".pages"] = types2pages( my_json_decode( "{\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"]}" ) );
$tdatatparam_uej[".originalPages"] = $tdatatparam_uej[".pages"];
$tdatatparam_uej[".defaultPages"] = my_json_decode( "{\"masterlist\":\"masterlist\",\"masterprint\":\"masterprint\"}" );
...
$tdatatparam_uej[".connId"] = "sep2_at_127_0_0_1";
