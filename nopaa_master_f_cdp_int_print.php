...
require_once("include/nopaa_master_f_cdp_int_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "nopaa_master_f_cdp_int" );
