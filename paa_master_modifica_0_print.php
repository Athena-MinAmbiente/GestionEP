...
require_once("include/paa_master_modifica_0_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "paa_master_modifica_0" );
