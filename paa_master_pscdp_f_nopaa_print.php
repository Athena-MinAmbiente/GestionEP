...
require_once("include/paa_master_pscdp_f_nopaa_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "paa_master_pscdp_f_nopaa" );
