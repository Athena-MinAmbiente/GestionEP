...
require_once("include/paa_master_stat_4_c_integrado_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "paa_master_stat_4_c_integrado" );
