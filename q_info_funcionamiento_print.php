...
require_once("include/q_info_funcionamiento_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "q_info_funcionamiento" );
