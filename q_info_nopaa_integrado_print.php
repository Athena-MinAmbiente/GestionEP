...
require_once("include/q_info_nopaa_integrado_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "q_info_nopaa_integrado" );
