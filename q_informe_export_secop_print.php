...
require_once("include/q_informe_export_secop_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "q_informe_export_secop" );
