...
require_once("include/q_seg_prog_inversion_001_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "q_seg_prog_inversion_001" );
