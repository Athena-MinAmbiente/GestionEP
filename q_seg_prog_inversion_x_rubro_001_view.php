...
require_once("include/q_seg_prog_inversion_x_rubro_001_variables.php");
...
$keys = array();
$keys["VIGENCIA"] = postvalue("editid1");
$keys["UEJ"] = postvalue("editid2");
$keys["RUBRO_ID_FK"] = postvalue("editid3");
